  ...
  return (
    <div>
      ...
      <div className="relative max-w-screen z-10 flex justify-center items-end ">
        ...
        <div className="absolute lg:-bottom-24 top-[50%] lg:top-[0%] bg-white lg:h-48 h-auto lg:w-[70%] w-[75%] shadow-2xl rounded-xl text-2xl px-5 flex flex-col justify-center">
