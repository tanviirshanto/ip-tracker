  ...
  return (
    <div>
      ...
      <div className="relative max-w-screen z-10 flex justify-center items-end ">
        ...
        <div className="absolute lg:-bottom-24 top-[70%] lg:top-auto bg-white min-h-40  lg:max-h-48 h-auto lg:w-[70%] w-[75%] shadow-2xl rounded-xl text-2xl px-5 flex flex-col justify-center">
          <div className="flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between text-black w-full text-xl font-bold lg:pl-10 py-8 lg:py-0 text-center lg:text-left">
